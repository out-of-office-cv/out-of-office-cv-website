...
Set up GitHub Actions workflow to automatically deploy the VitePress site to GitHub Pages on push to main.

Requirements:
- Use the same Node.js version as local development (check package.json or .nvmrc)
